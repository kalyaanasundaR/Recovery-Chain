...
import time
from domain.models import CaseState, RecoveryCase, RootCauseDiagnosis, DiagnosisStatus, ActionRecommendation, RecommendationStatus, CandidateAction
    ...
    if state["mode"] in ["C", "D", "REAL_LLM_RECOMMENDATION", "REAL_LLM_FULL_REASONING"]:
        try:
            ...
            rec = ActionRecommendation(
                ...
                top_candidate=top,
                status=RecommendationStatus.RECOMMENDED if top else RecommendationStatus.INSUFFICIENT_EVIDENCE,
