...
class RealGeminiAdapter:
    ...
    def diagnose(self, case: RecoveryCase) -> LLMDiagnosisOutput:
        ...
        # Clean schema for Gemini (remove $defs if any, simplify)
        # For simplicity, we define a basic dict schema that Gemini accepts
        gemini_schema = {
            "type": "OBJECT",
            "properties": {
            ...
            "required": ["diagnosis_category", "confidence", "evidence_references", "reasoning_summary"]
        }
