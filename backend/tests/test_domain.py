...
from domain.models import (
    Money, RecoveryCase, RevenueEvent, RiskCategory, CaseState,
...
def test_case_lifecycle_transitions():
    case = RecoveryCase(
        case_id="case_1", customer_id="cust_1",
...
def test_interfaces_load_correctly():
    ...
    from domain.interfaces import (
        ICaseRepository, IPolicyEvaluator, IAuditRecorder, 
        IPaymentAdapter, IOutcomeVerification
    )
