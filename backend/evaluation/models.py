...
from domain.models import RevenueEvent, ActionType, PolicyDecisionStatus, RecoveryOutcomeStatus

class GoldExpectation(BaseModel):
    expected_diagnosis_category: Optional[str] = None
    expected_action_type: Optional[ActionType] = None
    expected_policy_status: Optional[PolicyDecisionStatus] = None
    expected_execution_status: Optional[str] = None
    expected_outcome_status: Optional[RecoveryOutcomeStatus] = None
