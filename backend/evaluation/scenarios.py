...
from domain.models import RevenueEvent, RiskCategory, Money, ActionType, PolicyDecisionStatus, RecoveryOutcomeStatus
...
SCENARIOS = [
    ...
    EvaluationScenario(
        ...
        events=[create_event("FP_1", 100.0, 25, "FP_1", RiskCategory.FAILED_PAYMENT, {"failure_code": "insufficient_funds"})],
    ...
    EvaluationScenario(
        ...
        events=[create_event("FP_2", 15000.0, 25, "FP_2", RiskCategory.FAILED_PAYMENT, {"failure_code": "insufficient_funds"})],
        gold=GoldExpectation(
            expected_diagnosis_category="INSUFFICIENT_FUNDS",
            expected_action_type=ActionType.RETRY_PAYMENT,
    ...
    EvaluationScenario(
        ...
        events=[
            create_event("FP_3_1", 100.0, 50, "FP_3", RiskCategory.FAILED_PAYMENT, {"failure_code": "insufficient_funds"}),
            create_event("FP_3_2", 100.0, 48, "FP_3", RiskCategory.FAILED_PAYMENT, {"failure_code": "insufficient_funds"}),
            create_event("FP_3_3", 100.0, 46, "FP_3", RiskCategory.FAILED_PAYMENT, {"failure_code": "insufficient_funds"}),
            create_event("FP_3_4", 100.0, 44, "FP_3", RiskCategory.FAILED_PAYMENT, {"failure_code": "insufficient_funds"}),
        ],
        gold=GoldExpectation(
            expected_diagnosis_category="INSUFFICIENT_FUNDS",
            expected_action_type=ActionType.RETRY_PAYMENT,
    ...
    EvaluationScenario(
        ...
        events=[create_event("FP_4", 100.0, 25, "FP_4", RiskCategory.FAILED_PAYMENT, {"failure_code": "insufficient_funds"})],
        gold=GoldExpectation(
            expected_diagnosis_category="INSUFFICIENT_FUNDS",
            expected_action_type=ActionType.RETRY_PAYMENT,
            expected_policy_status=PolicyDecisionStatus.PERMITTED,
    ...
    EvaluationScenario(
        ...
        events=[create_event("FP_5", 100.0, 25, "FP_5", RiskCategory.FAILED_PAYMENT, {"failure_code": "insufficient_funds"})],
        gold=GoldExpectation(
            expected_diagnosis_category="INSUFFICIENT_FUNDS",
            expected_action_type=ActionType.RETRY_PAYMENT,
            expected_policy_status=PolicyDecisionStatus.PERMITTED,
    ...
    EvaluationScenario(
        ...
        events=[create_event("FP_6", 100.0, 1, "FP_6", RiskCategory.FAILED_PAYMENT, {"failure_code": "insufficient_funds"})],
        gold=GoldExpectation(
            expected_diagnosis_category="INSUFFICIENT_FUNDS",
            expected_action_type=ActionType.RETRY_PAYMENT,
    ...
    EvaluationScenario(
        ...
        events=[create_event("CA_1", 250.0, 25, "CA_1", RiskCategory.CHECKOUT_ABANDONMENT, {"checkout_stage": "payment"})],
        gold=GoldExpectation(
    ...
    EvaluationScenario(
        ...
        events=[
            create_event("CA_2_1", 250.0, 4, "CA_2", RiskCategory.CHECKOUT_ABANDONMENT, {"checkout_stage": "payment"}),
            create_event("CA_2_2", 250.0, 3, "CA_2", RiskCategory.CHECKOUT_ABANDONMENT, {"checkout_stage": "payment"}),
            create_event("CA_2_3", 250.0, 2, "CA_2", RiskCategory.CHECKOUT_ABANDONMENT, {"checkout_stage": "payment"}),
            create_event("CA_2_4", 250.0, 1, "CA_2", RiskCategory.CHECKOUT_ABANDONMENT, {"checkout_stage": "payment"})
        ],
        gold=GoldExpectation(
            expected_diagnosis_category="PAYMENT_FRICTION",
            expected_action_type=ActionType.SEND_CHECKOUT_REMINDER,
    ...
    EvaluationScenario(
        ...
        events=[create_event("FS_1", 50.0, 25, "FS_1", RiskCategory.FAILED_SUBSCRIPTION, {"failure_code": "mandate_revoked"})],
        gold=GoldExpectation(
    ...
    EvaluationScenario(
        ...
        events=[create_event("OI_1", 500.0, 25, "OI_1", RiskCategory.OVERDUE_INVOICE, {"days_overdue": 30})],
        gold=GoldExpectation(
    ...
    EvaluationScenario(
        ...
        events=[create_event("BP_1", 1000.0, 25, "BP_1", RiskCategory.BROKEN_PROMISE, {"promise_date_passed": True})],
        gold=GoldExpectation(
            expected_diagnosis_category="UNKNOWN",
